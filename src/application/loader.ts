...
class Loader {
    ...
    constructor() {
        new Promise((resolve, reject) => {
            // defer
            this._loaded.promise = new Promise((resolve, reject) => {
                this._loaded.resolve = resolve;
                this._loaded.reject = reject;
            });
            // progress
            if (!this.dom) {
                return reject(new Error('No loader DOM detected!'));
            }
            ...
            .then(() => {
                return this._loadData(this.environmentUrl)
            })
            .then((data: string) => {
